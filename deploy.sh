...
EMAIL="moddar8moulla@gmail.com" # replace with your own
...
echo "NEXT_API=$NEXT_API" >> "$APP_DIR/.env"
echo "NEXT_IMAGES_API=$NEXT_IMAGES_API" >> "$APP_DIR/.env"
echo "NEXT_DOMAIN=$NEXT_DOMAIN" >> "$APP_DIR/.env"
